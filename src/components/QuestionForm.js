...
function QuestionForm({ addQuest }) {
  // console.log(props);
  ...
  function handleSubmit(event) {
    ...
    const newDat = { prompt: formData.prompt, answers: [formData.answer1, formData.answer2, formData.answer3, formData.answer4], correctIndex: formData.correctIndex };
    console.log(newDat);
